...
$(window).load(function () {
    var phones = [{ "mask": "(+63)###-#######" }];
    $('.mobile_number_format').inputmask({
        mask: phones,
        greedy: false,
                            ...
                            switch (m.charAt(0)) {
                                ...
                                default:
                                    if (openenings.length > 0) {
                                        ...
                                        if (currentToken.isGroup || currentToken.isOptional) currentToken = new maskToken();
                            ...
                            for (var i = start; i <= end && i < getMaskLength(); i++) {
                                if (isMask(i)) {
                                    ...
                                    if (t != getPlaceHolder(i)) {
                                        var j = seekNext(i);
                                        if (j < getMaskLength()) {
                                            if (isValid(j, t, true) !== false && getActiveTests()[determineTestPosition(i)].def == getActiveTests()[determineTestPosition(j)].def) c = t;else {
